...
typedef enum {
	ILI9488_Orientation_0,
	ILI9488_Orientation_90,
	ILI9488_Orientation_180,
	ILI9488_Orientation_270
...
void ILI9488_FillArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
		uint16_t color);
